...
function AdminUserImages() {
  ...
  const handleOnClick = (e) => {
    ...
    // Here we need to grab the user from the url and connect the image with it.
    facade.fetchData(`pictures/${username}`, 'POST', clickedImage)
      .then((response) => {
...
export default AdminUserImages;
