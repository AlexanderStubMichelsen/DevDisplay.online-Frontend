...
const PrivacyPolicyOrganizedNotes = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800">
      <h1 className="text-3xl font-bold mb-6">Privacy Policy for Organized Notes</h1>

      <p className="mb-4">Effective Date: June 7, 2025</p>

      <p className="mb-4">
        Thank you for using <strong>Organized Notes</strong> (formerly <em>Authentic Notes</em>) (“we”, “us”, or “our”). We value your privacy and are committed to protecting your information. This Privacy Policy explains how we collect, use, and share data when you use our mobile app on Google Play.
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Usage statistics (e.g., note counts, session duration)</li>
      </ul>
      ...
      <p className="mb-4">
        We do <strong>not</strong> sell, rent, or trade your personal information. We may share anonymized data with third-party services (e.g., Firebase, analytics providers) to help us improve the app.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-2">4. Third-Party Services</h2>
      <p className="mb-4">
        Organized Notes may use third-party tools that collect data in accordance with their own privacy policies. Please review those policies for more details.
      </p>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Disable analytics or tracking through device settings</li>
...
export default PrivacyPolicyOrganizedNotes;
